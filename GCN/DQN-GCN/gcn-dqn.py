...
if __name__ == '__main__':
    ...
    for epoch in range(args.n_epochs):
        ...
        if epoch == 0:
            ...
            num_neighbors, fla, actions_value= RL.choose_action(s,epoch%10)
            if fla == 1:
                num_neighbor = num_neighbors[0]+1
            else:
                num_neighbor = num_neighbors+1

        p1, time_cost1 = runGraph(model1,g1,args,optimizer1,labels1,train_nid1,cuda,num_neighbor)
        p2, time_cost2 = runGraph(model2,g2,args,optimizer2,labels2,train_nid2,cuda,num_neighbor)
        p3, time_cost3 = runGraph(model3,g3,args,optimizer3,labels3,train_nid3,cuda,num_neighbor)
        ...
        # reward
        # r = pow(64,(acc-A))+math.log(max(time_cost_past-time_cost,0.1))
        r = pow(128,(acc-A))+1
