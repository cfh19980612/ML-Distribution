...
if __name__ == '__main__':
    ...
    dataframe.to_csv("/home/fahao/Py_code/results/GCN-Pubmed(8)/connection/connection.csv",header = False,index=False,sep=',')
    dataframes.to_csv("/home/fahao/Py_code/results/GCN-Pubmed(8)/connection/connection(round).csv",header = False,index=False,sep=',')
    dataframe_reward.to_csv("/home/fahao/Py_code/results/GCN-Pubmed(8)/connection/reward-connection.csv",header = False,index=False,sep=',')
    dataframes_reward.to_csv("/home/fahao/Py_code/results/GCN-Pubmed(8)/connection/reward-connection(round).csv",header = False,index=False,sep=',')
